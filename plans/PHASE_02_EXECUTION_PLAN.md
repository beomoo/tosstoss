...
- Current checkpoint: `CP3-C2-B2-A PASS — CLOSED / CP3-C2-B2-B PASS — CLOSED / CP3-C2-B IMPLEMENTATION IN PROGRESS / ADR-015 ACCEPTED / ADR-016 ACCEPTED / ADR-017 PROPOSED / CP3-C2-B2-C 0006 PASS — CLOSED / B2-C R1 BLOCKED — APPROVED RUNTIME CONTRACT GAP`
...
- ADR-017: `PROPOSED` (`2026-08-28`), decision date `NONE`. It proposes only
  exact JSON/COSE/challenge/authentication canonicalization and hash preimages;
  it is not self-accepted implementation authority.
- `0006`: `PASS — CLOSED`
- B2-C WebAuthn/human-approval runtime:
  `NOT STARTED / BLOCKED — APPROVED RUNTIME CONTRACT GAP / ADR-017 PROPOSED`
- B2-D: `NOT STARTED`
...
before code changes, so B2-C R1 is not started and remains
