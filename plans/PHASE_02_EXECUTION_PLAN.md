...
- Current checkpoint: `CP3-C2-B2-A PASS — CLOSED / CP3-C2-B2-B PASS — CLOSED / CP3-C2-B IMPLEMENTATION IN PROGRESS / ADR-015 ACCEPTED / ADR-016 ACCEPTED / ADR-017 PROPOSED — AWAITING INDEPENDENT RE-REVIEW / ADR-018 PROPOSED — AWAITING INDEPENDENT REVIEW / CP3-C2-B2-C 0006 PASS — CLOSED / B2-C R1 NOT STARTED — BLOCKED`
...
`NOT STARTED / BLOCKED — ADR-017/ADR-018 REVIEW REQUIRED`; future `0007` is
`NOT CREATED / NOT AUTHORIZED`;
...
- ADR-017: `PROPOSED — AWAITING INDEPENDENT RE-REVIEW` (`2026-08-28`), decision
...
- ADR-018: `PROPOSED — AWAITING INDEPENDENT REVIEW` (`2026-08-28`), decision date `NONE`. It selects a fresh
...
authorized. B2-C R1 remains `BLOCKED — ADR-017/ADR-018 REVIEW REQUIRED`;
