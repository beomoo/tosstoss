...
- Current checkpoint: `CP3-C2-B2-A PASS — CLOSED / CP3-C2-B2-B PASS — CLOSED / CP3-C2-B IMPLEMENTATION IN PROGRESS / ADR-015 ACCEPTED / ADR-016 ACCEPTED / ADR-017 PROPOSED — CHANGES REQUIRED / RG-06 OPEN / ADR-018 PROPOSED / CP3-C2-B2-C 0006 PASS — CLOSED / B2-C R1 NOT STARTED — BLOCKED`
...
`NOT STARTED / BLOCKED — ADR-017 CHANGES REQUIRED / RG-06 OPEN / ADR-018
PROPOSED`; future `0007` is `NOT CREATED / NOT AUTHORIZED`;
...
| CP3-C2-B implementation | `IN PROGRESS` | B2-A/B2-B/`0006` schema closed; B2-C R1 blocked on proposed ADR-017 |
...
- B2-C: `0006 PASS — CLOSED`; R1 runtime은 ADR-017 `PROPOSED`로 미착수 / blocked
...
- ADR-017: `PROPOSED — CHANGES REQUIRED / RG-06 OPEN` (`2026-08-28`), decision
  date `NONE`. RG-01~RG-05 remain conceptually approved; RG-07 now names the
  WebAuthn-required CTAP2 canonical CBOR form. RG-06 requires the separately
  proposed counter bootstrap; ADR-017 is not self-accepted authority.
- ADR-018: `PROPOSED` (`2026-08-28`), decision date `NONE`. It selects a fresh
  one-time assertion after registration zero and proposes the minimum future
  pre-admission ledger. Future `0007` is necessary but `NOT CREATED / NOT
  AUTHORIZED`.
- `0006`: `PASS — CLOSED`
- B2-C WebAuthn/human-approval runtime:
  `NOT STARTED / BLOCKED — ADR-017 RG-06 OPEN / ADR-018 PROPOSED`
...
before code changes. Independent review of ADR-017 SHA
`c76fe7616db65c53ffc5a81d3e3c0cb390c0fa3b` returned `CHANGES REQUIRED`, P0
`0`, P1 `1`, P2 `2`; RG-06 remains open. ADR-018 proposes Option C and a
necessary future `0007`, but neither is accepted or authorized. B2-C R1 is not
started and remains `BLOCKED — ADR-017 RG-06 OPEN / ADR-018 PROPOSED`;
