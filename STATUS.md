...
- 프로젝트 상태: `PHASE 2 IMPLEMENTATION IN PROGRESS — CP2 COMPLETE / CP3-A PASS — CONTRACT APPROVED AND CLOSED / CP3-B PASS — CLOSED / CP3-C1 PASS — CLOSED / CP3-C2-A PASS — CONTRACT APPROVED AND CLOSED / CP3-C2-B1 PASS — CONTRACT APPROVED AND CLOSED / CP3-C2-B IMPLEMENTATION IN PROGRESS / CP3-C2-B2-A PASS — CLOSED / CP3-C2-B2-B PASS — CLOSED / ADR-015 ACCEPTED / ADR-016 ACCEPTED / ADR-017 PROPOSED — CHANGES REQUIRED / RG-06 OPEN / ADR-018 PROPOSED / CP3-C2-B2-C 0006 PASS — CLOSED / B2-C R1 NOT STARTED / BLOCKED / CP3-C2-B2-D NOT STARTED / CP3-C2-C NOT STARTED / CP3-D NOT STARTED`
- 현재 Phase: `Phase 2 — CP3-C2-B2-A PASS — CLOSED; CP3-C2-B2-B PASS — CLOSED; CP3-C2-B implementation IN PROGRESS; CP3-C2-B2-C 0006 schema PASS — CLOSED; B2-C R1 NOT STARTED / BLOCKED — ADR-017 RG-06 OPEN / ADR-018 PROPOSED`
- 현재 버전: `0.1.0`
...
- 최종 QA일: `2026-08-28 (ADR-017 counter-capability remediation and ADR-018 proposal; R1 remains blocked)`
- 실제 API 연결: `CP2-D2 one-shot PASS — OAuth + GET /api/v1/stocks만 검증`
- 실제 주문 기능: `비활성 / 비범위`
- OpenAI API 사용: `아니오`
- Phase 2 상태: `CP1 PASS / CP2 COMPLETE / CP3-A PASS — CONTRACT APPROVED AND CLOSED / CP3-B PASS — CLOSED / CP3-C1 PASS — CLOSED / CP3-C2-A PASS — CONTRACT APPROVED AND CLOSED / CP3-C2-B1 PASS — CONTRACT APPROVED AND CLOSED / CP3-C2-B IMPLEMENTATION IN PROGRESS / CP3-C2-B2-A PASS — CLOSED / CP3-C2-B2-B PASS — CLOSED / ADR-015 ACCEPTED / ADR-016 ACCEPTED / ADR-017 PROPOSED — CHANGES REQUIRED / RG-06 OPEN / ADR-018 PROPOSED / CP3-C2-B2-C 0006 PASS — CLOSED / B2-C R1 BLOCKED / CP3-C2-B2-D NOT STARTED / CP3-C2-C NOT STARTED / CP3-D NOT STARTED`
- CP3-B: `PASS — CLOSED`
- CP3-C1: `PASS — CLOSED`
...
- ADR-017: `PROPOSED — CHANGES REQUIRED / RG-06 OPEN` (`2026-08-28`),
  decision date `NONE`
- ADR-018: `PROPOSED` (`2026-08-28`), decision date `NONE`
...
- B2-C WebAuthn/human-approval runtime:
  `NOT STARTED / BLOCKED — ADR-017 RG-06 OPEN / ADR-018 PROPOSED`
...
`PASS — CLOSED`. Independent review of ADR-017 SHA
`c76fe7616db65c53ffc5a81d3e3c0cb390c0fa3b` returned `CHANGES REQUIRED`, P0
`0`, P1 `1`, P2 `2`: RG-01~RG-05 remain conceptually approved, RG-06 counter
bootstrap is open, and RG-07 requires CTAP2 canonical CBOR terminology. The
remediation selects Option C and proposes, but does not accept, ADR-018 plus a
necessary future `0007`; no migration was created or authorized. B2-C R1 is
`NOT STARTED / BLOCKED — ADR-017 RG-06 OPEN / ADR-018 PROPOSED`. B2-D,
