...
_TABLE_DDL: tuple[tuple[str, str], ...] = (
	...
	UNIQUE (webauthn_credential_id, reviewer_principal_id, credential_id_fingerprint, public_key_fingerprint, rp_id),
	...
	FOREIGN KEY(webauthn_credential_id, reviewer_principal_id, credential_id_fingerprint, public_key_fingerprint, rp_id) REFERENCES reviewer_webauthn_credentials (webauthn_credential_id, reviewer_principal_id, credential_id_fingerprint, public_key_fingerprint, rp_id),
